...
AUTO_COIN_MIN_ATR_PCT = 0.10
AUTO_COIN_SCORE_ATR_WEIGHT = 2.2
AUTO_COIN_SCORE_VALUE_WEIGHT = 0.08
AUTO_COIN_SCORE_FRICTION_WEIGHT = 0.01

# Freqtrade-inspired logic (optional)
FT_LOGIC_ENABLED_DEFAULT = False
FT_SIGNAL_ONLY_DEFAULT = False
FT_ENTRY_EMA_FILTER_DEFAULT = True
FT_ENTRY_RSI_FILTER_DEFAULT = True
FT_ENTRY_VOL_FILTER_DEFAULT = False
FT_EXIT_SIGNAL_ENABLED_DEFAULT = False
FT_EXIT_RSI_SIGNAL_DEFAULT = False
FT_ROI_ENABLED_DEFAULT = False

FT_EMA_FAST_DEFAULT = 12
FT_EMA_SLOW_DEFAULT = 26
FT_RSI_PERIOD_DEFAULT = 14
FT_RSI_ENTRY_MAX_DEFAULT = 60.0
FT_RSI_EXIT_MIN_DEFAULT = 70.0
FT_VOL_PERIOD_DEFAULT = 20
FT_VOL_MULT_DEFAULT = 0.8
FT_EXIT_MIN_PROFIT_PCT_DEFAULT = 0.10
FT_ROI_TABLE_DEFAULT = "0:1.0,5:0.6,10:0.3"
...
# Multipliers applied to average candle move % based on trend
